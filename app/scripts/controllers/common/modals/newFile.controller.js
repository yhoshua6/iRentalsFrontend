(function() {
  ...
  newFileCtrl.$inject = ["$mdDialog", "userInfoService", "toastServices", "Upload", "FILES_DEPOT"];
  function newFileCtrl($mdDialog, userInfoService, toastServices, Upload, FILES_DEPOT) {
